...
class videoReader(object):
    """A class for reading videos and extracting frames at specified intervals and frequencies.

    Attributes:
        video_path (str): The path to the video file to be processed.
        frame_interval (int): The interval between frames to be captured.
        frame_kept_per_second (int): The number of frames to be kept per second of video.
    """
    ...
    def video2frame(self, frame_save_path):
        """Extracts frames from the video at the specified frame interval and saves them to the given path.

        Args:
            frame_save_path (str): The directory path where the extracted frames will be saved.
        """
    ...
    def video2frame_update(self, frame_save_path, min_save_frame=3):
        """Extracts frames from the video based on a specified frame rate and minimum number of frames,
        and saves them to a given path.

        Args:
            frame_save_path (str): The directory path where the extracted frames will be saved.
            min_save_frame (int): The minimum number of frames to save from the video.
        """
        self.frame_save_path = frame_save_path
    ...
    def video2frame_update_SE(self, frame_save_path, min_save_frame=3, start_t=0, end_t=10):
        ...
        Args:
            frame_save_path (str): The directory path where the extracted frames will be saved.
            min_save_frame (int): The minimum number of frames to save from the video.
            start_t (int): The start time (in seconds) of the video segment from which frames are to be extracted.
            end_t (int): The end time (in seconds) of the video segment for frame extraction.
        """
        self.frame_save_path = frame_save_path
...
class AVE_dataset(object):
    """A class for processing audio and video data from a dataset, including extracting images and audio
    features and saving them to disk.

    Attributes:
        path_to_dataset (str): The base path to the dataset directory.
        frame_interval (int): The interval between frames to be captured (passed to videoReader).
        frame_kept_per_second (int): The number of frames to be kept per second of video (passed to videoReader).
    """
    def __init__(self, path_to_dataset='../data/ave/', frame_interval=1, frame_kept_per_second=1):
    ...
    def extractImage_SE(self):
        ...
        for each_video in self.file_list[1:]:
            ...
            self.videoReader.video2frame_update_SE(frame_save_path=save_dir, min_save_frame=10,
                                                   start_t=start_t, end_t=end_t)  # take a min of 10 frames
